  ...
  return (
    <article className="about-page">
      ...
      <section>
        <h2>使い方</h2>
        <ol>
          <li><strong>写真鑑識</strong> — 写真をアップすると、黄色いログが浮かびます。タップで詳細（メタン情報）を見られます。位置はブラウザの許可、または写真内の位置情報（EXIF）を使います（EXIFは同意チェック時のみ）。</li>
        ...
        <p className="about-purpose-lead">例えば、こんな目的で。</p>
        <ul>
      ...
      <section>
        ...
        <ul>
          ...
          <li>位置情報は概算で保存・表示されます。写真鑑識でEXIFの位置を使う場合は、画面上で同意をいただいたうえで、その鑑識処理のためだけに読み取ります（サーバーに写真ファイル自体は保存しません）。</li>
