  ...
  return (
    <article className="about-page">
      ...
      <section>
        <h2>このサイトを作った想い</h2>
        <p>
          道を歩いていると、ふいに後ろを振り返る人がいる。あれは、自分のおならがバレていないか確かめているのではないか——そんなことをふと思ったのが、きっかけのひとつです。
        </p>
        <p>
          株式会社ワカモノリサーチの調査（
          <a
          ...
          ）を読んで、他人の目をいちばん気にする思春期の高校生でも約60％が外での放屁を経験している。他の世代なら、ほぼ100％に近いんじゃないか。意外と、みんな公共の場でおならをしているんじゃないか——そう感じました。
        </p>
        <p>
